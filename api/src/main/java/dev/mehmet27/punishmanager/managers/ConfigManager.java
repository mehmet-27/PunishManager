...
import dev.mehmet27.punishmanager.objects.PlayerLocale;
...
public class ConfigManager {
    ...
    public void setup() {
        ...
        try {
            ...
            InputStream stream = PunishManager.getInstance().getResourceStream("locales/en_US.yml");
            defaultMessages = ConfigurationProvider.getProvider(YamlConfiguration.class).load(stream);
        } catch (IOException e) {
            e.printStackTrace();
        }
